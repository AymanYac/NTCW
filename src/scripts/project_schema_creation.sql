...
EXECUTE format('
   CREATE TABLE IF NOT EXISTS %I.project_values(value_id character varying primary key,nominal_value character varying,min_value character varying,max_value character varying,note character varying,uom_id character varying
)',  project_id);
