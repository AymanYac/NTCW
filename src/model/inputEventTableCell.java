                    ...
                    public void handle(Event event) {
                        try{
                            ...
                            ligne2.setOnMouseClicked(new EventHandler<MouseEvent>() {
                                @Override
                                public void handle(MouseEvent event) {
                                    CaracDeclarationDialog.CaracDeletion(((CharPaneRow)table.getItems().get(result.getIndex())).getCarac(),parent.tableController.tableGrid.getSelectionModel().getSelectedItem().getClass_segment_string().split("&&&")[0]);
                                    popup.hide();
                                    parent.refresh_ui_display();
                                }
                            });
