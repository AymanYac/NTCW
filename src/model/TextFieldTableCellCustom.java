 ...
 * @since JavaFX 2.2
 */
public class TextFieldTableCellCustom<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new TextFieldTableCellCustom<S,T>(converter);
    }
     ...
     */
    public TextFieldTableCellCustom() {
        this(null);
    }
     ...
     *      type T.
     */
    public TextFieldTableCellCustom(StringConverter<T> converter) {
    ...
    @Override public void startEdit() {
        ...
        if (isEditing()) {
            ...
            CellUtilsCustom.startEdit(this, getConverter(), null, null, textField);
        }
    }
    ...
    @Override public void cancelEdit() {
        super.cancelEdit();
        CellUtilsCustom.cancelEdit(this, getConverter(), null);
    }

    /** {@inheritDoc} */
    @Override public void updateItem(T item, boolean empty) {
        super.updateItem(item, empty);
        CellUtilsCustom.updateItem(this, getConverter(), null, null, textField);
    }
}
